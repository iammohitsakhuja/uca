...
public class ReverseStringAndStringBuilder {
  public static void main(String[] args) {
    ...
    System.out.println(
        "Elapsed Time is "
            + elapsedTime / 1000
            + " usec (Using StringBuffer's append() to reverse)");
    ...
    System.out.println(
        "Elapsed Time is "
            + elapsedTime / 1000
            + " usec (Using StringBuilder's append() to reverse)");
    ...
    elapsedTime = System.nanoTime() - beginTime;
    System.out.println(
        "Elapsed Time is " + elapsedTime / 1000 + " usec (Using StringBuidler's reverse() method)");
  }
}
